...
import { STUDENT_ADD_RESET, STUDENT_UPDATE_RESET } from "../constants/studentConstant";
...
const AddStudentView = () => {
  ...
  useEffect(() => {
    ...
    if (success && !isEdit) {
      dispatch({ type: STUDENT_ADD_RESET });
      setSuccessMessage("Student added. You can add another one.");
      setName("");
      setAddress("");
      setCategory("");
      setCity("");
  ...
  }, [dispatch, history, success, successUpdate, isEdit]);
