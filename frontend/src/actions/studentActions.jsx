...
export const listStudents = (keyword = "", pageNumber = "") => async (
  ...
  try {
    ...
    const { data } = await axios.get(
      `/api/student/all?keyword=${keyword}&pageNumber=${pageNumber}`,
      config
    );
    dispatch({
...
export const addStudent = (student) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`/api/student/addStudent`, student, config);
...
export const getStudentsByRoomNo = (roomNo) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`/api/student/room/${roomNo}`, config);
    dispatch({
